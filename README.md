<p align="center">
  <img src="doc/images/logo.png" width="300" alt="Spot-xTak logo">
</p>
...
- Python 3.x
- Dependencies listed in `requirements.txt` (installed below)
...
1. Login to your SPOT account: [myaccount.findmespot.com/login](https://myaccount.findmespot.com/login)
2. Create an XML Feed for your devices
3. View Details — copy the XML Feed ID
4. Paste the XML Feed ID into `spot_feed_id.txt`
5. Set the parameters by editing `config.ini`
6. Run `$ python3 spot-xtak.py`

<p align="center">
  <img src="doc/images/spot-xtak.jpeg" width="600" alt="Spot-xTak markers shown on a TAK map">
</p>
...
2026 Globalstar®. All rights reserved." This project consumes the
SPOT shared-page XML feed (public, or password-protected via
`SPOT_FEED_PASSWORD`) and is not a Globalstar product.
